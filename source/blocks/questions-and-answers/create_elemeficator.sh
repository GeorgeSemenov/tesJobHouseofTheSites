#!/bin/sh
parentName=questions-and-answers
...
end1
cat questions-and-answers.pug >> newFile.pug
mv -f newFile.pug  questions-and-answers.pug
...
cat >> questions-and-answers.scss << end3
