#!/bin/sh
parentName=domains-and-servers-container
...
end1
cat domains-and-servers-container.pug >> newFile.pug
mv -f newFile.pug  domains-and-servers-container.pug
...
cat >> domains-and-servers-container.scss << end3
